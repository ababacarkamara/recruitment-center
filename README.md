...
To build the final jar and optimize the recruitmentCenter application for production, run:
...
Then navigate to [http://localhost:8061](http://localhost:8061) in your browser.
